document.addEventListener('DOMContentLoaded', function () {
  ...
  // Re-observe dynamically added elements (basic mutation support)
    ...
    const mutationObserver = new MutationObserver(function (mutations) {
      mutations.forEach(function (mutation) {
        mutation.addedNodes.forEach(function (node) {
          ...
          const children = node.querySelectorAll && node.querySelectorAll('.' + OBSERVE_CLASS + ':not(.' + ANIMATION_CLASS + ')');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אדל תספורות בע\"מ משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '09debd6e-67ce-429d-b20d-c2138bb50335',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '09debd6e-67ce-429d-b20d-c2138bb50335';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '09debd6e-67ce-429d-b20d-c2138bb50335';
